...
Built with JavaScript, MediaPipe hand tracking, and the Web Audio API. No React. No npm. Nothing to install.
...
**1. clone the repo**
```bash
git clone https://github.com/ElliotTerminal/campuzzle.git
cd campuzzle
```

**2. open in VS Code and click Go Live**

Install the [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) extension by Ritwick Dey. Then click **Go Live** in the bottom right corner.
...
## How to Play (also in guide.html)
...
- **download button** appears at the bottom of every captured photo to download separately
...
if you try this i would genuinely love to see your photo-booth strip. tag me **@dorara.pvt** on Instagram — have fun with it!
